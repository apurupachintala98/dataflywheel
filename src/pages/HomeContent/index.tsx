...
//     type: keyof typeof anchorEls
//   ) => {
//     const target = e.currentTarget;

//     if (type === "upload") {
//       if (anchorEls.upload === target) {
//         handleMenuClose(); // toggle close
//       } else {
//         setAnchorEls((prev) => ({ ...prev, upload: target }));
//       }
//     } else {
...
//     if (type === 'yaml') {
//       // Logic for YAML file handling
//     } else {
//       // Logic for Data file handling
//     }
//   };
...
//               <p style={{ fontSize: "18px", fontWeight: "bold", textAlign: "center" }}>Error communicating with backend.</p>
//             </div>
//           ),
//           fromUser: false,
//           showExecute: false,
...
//               <tr>
//                 {columns.map(col => (
//                   <th key={col} style={{ border: '1px solid black', padding: '8px', textAlign: 'left' }}>{col}</th>
//                 ))}
//               </tr>
//             </thead>
//             <tbody>
...
//                 <tr key={i}>
//                   {columns.map(col => (
//                     <td key={`${i}-${col}`} style={{ border: '1px solid black', padding: '8px' }}>
